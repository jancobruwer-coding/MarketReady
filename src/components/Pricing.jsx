...
const Pricing = () => {
  const plans = [
    {
      name: "Core Package",
      desc: "Provides the basic services to sell your house.",
      price: "2,000",
      isMostPop: false,
      features: [
        "House Analysis",
    ...
    },
    {
      ...
      desc: "Provides every available service.",
      price: "8,000",
      isMostPop: true,
      features: [
        "House Analysis",
      ...
      <div className="relative max-w-screen-xl mx-auto text-gray-300 sm:px-4 md:px-8">
        <div className="max-w-xl mx-auto space-y-3 px-4 sm:text-center sm:px-0">
          ...
          <div className="max-w-xl">
            <p>
              We provide various pricing packages, each with their one services.
              All prices will include a 5% commission (VAT included) on the
              final sale, with a monthly price based on the package.
            </p>
          </div>
        </div>
